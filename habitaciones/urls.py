...
urlpatterns = [
    ...
    path('habitaciones/buscar_habitaciones/', views.buscar_habitaciones, name='buscar_habitaciones'),
    ...
    path('habitaciones/reservas-todas/', views.reservas_todas, name='reservas_todas'),
